...
class ABCLocalScraper(scraper.FeedScraper):
    def __init__(self, configFile):
        super(ABCLocalScraper, self).__init__(models.FEED_ABCLOCAL,
                                             configFile, models)
        
    def run(self):
        self.logInfo("START ABC Local Feed Scraper")
        ...
        self.logInfo("END ABC Local Feed Scraper")
...
def main():
    ...
    scraper = ABCLocalScraper(configPath)
    scraper.run() 
