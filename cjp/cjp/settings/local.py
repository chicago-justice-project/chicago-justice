...
DATABASES = {
    'default': {
        ...
        'HOST': get_env_variable('DATABASE_HOST'),                      # Set to empty string for localhost. Not used with sqlite3.
        'PORT': get_env_variable('DATABASE_PORT', '5432'),                      # Set to empty string for default. Not used with sqlite3.
    }
}
